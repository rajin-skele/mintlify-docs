...
```html
<div class="static p-4 bg-blue text-white rounded">
  Static positioning
</div>
<div class="relative p-4 bg-green text-white rounded">
...
<div class="relative bg-gray-light p-8 rounded">
  <div class="absolute p-4 bg-red text-white rounded" style="top: 1rem; right: 1rem;">
...
<div class="flex gap-6">
  <aside class="w-1-4 sticky h-screen overflow-auto" style="top: 0;">
