...
<div
  ...
  class="overflow-hidden border-1 border-solid border-gray rounded"
>
  <p class="p-4">
...
<div
  style="width: 18rem; height: 8rem;"
  class="overflow-auto border-1 border-solid border-gray rounded"
>
  <p class="p-4">
...
<div class="max-w-2xl mx-auto">
  <div
    style="height: 24rem;"
    class="overflow-auto border-1 border-solid border-gray rounded-lg p-6"
  >
    ...
    <p class="mb-4">Additional content that causes scrolling...</p>
  </div>
</div>
```
...
```html
<div style="height: 16rem;" class="w-full overflow-hidden rounded-lg">
...
>
  <div
    class="bg-white rounded-lg max-w-md w-full mx-4 overflow-auto"
