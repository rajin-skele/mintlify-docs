...
import { ResponsiveUtilitiesDemo } from "/snippets/responsive-utilities-demo.jsx"
...
<div class="flex flex-col flex-row--on-m gap-4">
  <div class="w-1-2 p-4 bg-blue text-white rounded">A</div>
  <div class="w-1-2 p-4 bg-gray-light rounded">B</div>
</div>
```
...
<div class="flex flex-row flex-col--on-m gap-6">
  <div class="w-1-2 p-6 bg-white rounded-lg">Primary column</div>
  <div class="w-1-2 p-6 bg-gray-light rounded-lg">Secondary column</div>
</div>
```
...
<nav class="flex items-center justify-between justify-center--on-xs gap-4">
  ...
  <div class="flex gap-4 hidden--on-xs">
    <a href="#" class="text-gray">Docs</a>
    <a href="#" class="text-gray">Support</a>
  </div>
</nav>
```
