...
```html
<div class="block p-4 bg-blue text-white rounded">
...
<div class="flex items-center gap-4">
  <div class="p-4 bg-blue text-white rounded">
    Item 1
  </div>
  <div class="p-4 bg-green text-white rounded">
    Item 2
  </div>
  <div class="p-4 bg-red text-white rounded">
    Item 3
  </div>
</div>
```
