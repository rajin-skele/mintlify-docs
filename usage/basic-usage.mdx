---
title: "Basic Usage"
description: "How to use Skelementor utility classes in Elementor v4"
---
...
Once you've imported the Skelementor utility framework, you can use classes on any Elementor atomic element.
...
```html
<div class="card p-6 rounded-lg bg-white border-1 border-solid border-gray-light">
...
<div class="flex items-center gap-4 p-6 bg-white rounded-lg">
  <img class="rounded-full" src="avatar.jpg" style="width: 3rem; height: 3rem;"/>
  <div>
