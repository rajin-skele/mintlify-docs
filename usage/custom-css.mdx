---
title: "Custom CSS"
description: "Writing and importing your own utility classes with Skelementor"
---
...
1. Open the Skelementor admin screen in WordPress
...
```html
<h1 class="hero-title text-brand">
  Custom Hero Title
</h1>
<div class="bg-brand spacing-xl">
