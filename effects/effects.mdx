...
```html
<button class="btn btn-blue opacity-50">Disabled Button</button>
...
<div class="relative">
  ...
  <div
    class="absolute bg-white opacity-75 flex items-center justify-center rounded-lg"
    style="top: 0; right: 0; bottom: 0; left: 0;"
  >
...
<CardGroup cols={2}>
  ...
  <Card title="Components" icon="puzzle-piece" href="/overview/components">
    Cards, buttons, and bundled UI patterns
  </Card>
