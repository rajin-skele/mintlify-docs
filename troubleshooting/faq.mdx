---
title: "FAQ"
description: "Frequently asked questions about the utility importer"
---
...
<AccordionGroup>
  ...
  <Accordion title="Can I combine multiple utility classes?">
    **Yes!** You can combine multiple classes for complex designs:
    ...
    ```html
    <div
      class="flex items-center justify-between p-6 bg-white rounded-lg border-1 border-solid border-gray-light"
    >
...
<AccordionGroup>
  <Accordion title="Can I modify existing utility classes?">
    **Yes.** To modify an existing class:
    ...
    3. Re-import through the importer
  </Accordion>
