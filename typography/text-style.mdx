...
import { TextStyleDemo } from "/snippets/text-style-demo.jsx"
...
<p class="text-base text-gray">
  Try the bundled
  <a class="text-blue underline font-medium">
    text decoration utilities
  </a>
  or disable decoration with
  <a class="text-blue no-underline font-medium">
    class="no-underline"
  </a>
  .
</p>
<blockquote class="text-lg italic text-gray-dark pl-4" style="border-left: 4px solid #3b82f6;">
