...
<p class="text-base text-gray">
  Try the bundled <a class="text-blue underline font-medium">text decoration utilities</a> or disable decoration with
  <a class="text-blue no-underline font-medium">class="no-underline"</a>.
</p>
<blockquote
  class="text-lg italic text-gray-dark pl-4"
