      ...
      >
        <div style={{ marginBottom: "1rem" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              {widths.map((width) => (
                <option key={width.label} value={width.label}>
        ...
        <div
          style={{ padding: "1.5rem", borderRadius: "0.5rem", transition: "all 0.2s ease" }}
          className="bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700"
        >
          <div
            style={{
              width: widths.find((width) => width.label === selectedWidth)?.value,
              height: "70px",
              borderRadius: "0.5rem",
              display: "flex",
              alignItems: "center",
