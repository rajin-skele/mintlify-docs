...
export const LetterSpacingDemo = () => {
  ...
  const spacings = [
    ...
    { label: "tracking-extra-tight", value: "-0.075em" },
    ...
    { label: "tracking-extra-wide", value: "0.15em" },
    { label: "tracking-ultra-wide", value: "0.2em" },
  ];

  const currentSpacing = spacings.find((item) => item.label === selectedSpacing);
      ...
      >
        ...
        <div style={{ padding: "2rem", borderRadius: "0.5rem", transition: "background-color 0.2s ease, border-color 0.2s ease" }} className="bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700">
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div>
              <div style={{ fontSize: "0.75rem", marginBottom: "0.5rem", fontWeight: "500", transition: "color 0.2s ease" }} className="text-zinc-500 dark:text-zinc-400">
                Heading
              </div>
              <h2
                style={{
                  letterSpacing: currentSpacing?.value,
                  fontSize: "2rem",
                  fontWeight: "700",
        ...
        <div style={{ marginTop: "0.75rem", fontSize: "0.75rem", textAlign: "center", transition: "color 0.2s ease" }} className="text-zinc-500 dark:text-zinc-400">
          .{selectedSpacing} • {currentSpacing?.value}
        </div>
      </div>
    </div>
  );
