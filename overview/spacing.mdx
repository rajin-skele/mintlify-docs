---
title: "Spacing"
description: "Margin, padding, and gap utilities built around the bundled spacing scale."
---

## Overview

Spacing utilities use the bundled spacing tokens directly. Margin, padding, and gap default to the framework's responsive spacing scale where available, while zero, auto, and pixel helpers remain fixed for precise control.
...
<Info>
This scale is reused across margin, padding, and the core `gap-*` classes. Larger gap-only steps extend the same rhythm for layout sections.
</Info>
...
<section class="cont my-12">
  <div class="card p-8">
    ...
    <p class="text-base leading-relaxed text-gray-dark mb-8">
      Use the default `m-*`, `p-*`, and `gap-*` families directly.
    </p>
