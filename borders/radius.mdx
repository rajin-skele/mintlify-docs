...
```html
<div class="border-2 border-solid border-gray rounded-none p-4">Square corners</div>
<div class="border-2 border-solid border-gray rounded-sm p-4">Small rounding</div>
<div class="border-2 border-solid border-gray rounded p-4">Standard rounding</div>
<div class="border-2 border-solid border-gray rounded-lg p-4">Large rounding</div>
<div class="border-2 border-solid border-gray rounded-xl p-4">Extra large rounding</div>
<div class="border-2 border-solid border-gray rounded-full p-4">Fully rounded</div>
```
...
<input
  type="text"
  class="w-full p-3 border-1 border-solid border-gray rounded-lg"
  placeholder="Large radius input"
>
```

```html
<div style="width: 4rem; height: 4rem;" class="overflow-hidden rounded-full">
