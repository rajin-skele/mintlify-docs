...
<div class="card border-2 border-solid border-gray">
  ...
  <p class="text-gray">
    Use the bundled border classes directly.
  </p>
</div>
```
...
```html
<input class="w-full p-3 border-1 border-solid border-gray rounded" placeholder="Normal input" type="text"/>
```
...
<div class="border-4 border-solid border-blue rounded-lg p-6 bg-white">
  ...
  <p class="text-gray">
    Heavier widths work best for emphasis and framing.
  </p>
</div>
```
